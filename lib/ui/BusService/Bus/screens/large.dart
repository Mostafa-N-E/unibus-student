...
class LargeBusPage extends StatefulWidget {
  final UserInfo user_info;
  final List<TurnEntity> turns;
  final List<NotificationEntity> notifications;

  const LargeBusPage({Key? key, required this.turns, required this.user_info, required this.notifications}) : super(key: key);

  @override
  State<LargeBusPage> createState() => _LargeBusPageState();
}

class _LargeBusPageState extends State<LargeBusPage> {
