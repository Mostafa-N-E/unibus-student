...
import '../../../../ui/BusService/ReserveBus/screens/large.dart';
import '../../../../ui/BusService/ReserveBus/screens/small.dart';
import '../../../../ui/BusService/ReserveBus/widgets/floating_action_button.dart';
import '../../../utils/responsiveLayout.dart';

class ReserveBusScreen extends StatelessWidget {
  ReserveBusScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayout(
      largeScreen: LargeReserveBusPage(),
      // smallScreen: SmallFoodPage(),
      smallScreen: SmallReserveBusPage(),
    );
    // return BlocProvider(
    //   create: (context) {
