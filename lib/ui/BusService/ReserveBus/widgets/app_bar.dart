...
class ReserveBusSmallScreenAppBar {
  // final date_piker_onTap;
  // final self_service_selecter_onTap;
  // final date_lable;
  // final self_service_lable;
  final BuildContext context;
  const ReserveBusSmallScreenAppBar(this.context);

  AppBar build({Function()? date_piker_onTap, Function()? dormitory_selecter_onTap,  String dormitory_lable="", required String date_lable,}) {
                ...
                Padding(
                  ...
                  child: Card(
                    ...
                    child: SizedBox(
                      ...
                      width: item_width,
                      child: dormitory_lable == "" ?
                          const Center(child: CircularProgressIndicator(),)
                          :
                      InkWell(
                        // hoverColor: Colors.white70,
                        enableFeedback: true,
                        onTap: dormitory_selecter_onTap,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
...
class ReserveBusLargeScreenAppBar {
  // final date_piker_onTap;
  // final self_service_selecter_onTap;
  // final date_lable;
  // final self_service_lable;
  final BuildContext context;
  const ReserveBusLargeScreenAppBar(this.context);
