...
import '../ReserveFood/ReserveFood.dart';
    ...
    return BlocProvider(
      create: (context) {
        final foodBloc = FoodBloc(
            mealFoodRepository: mealFoodRepository, notificationRepository: notificationRepository
        );
        foodBloc.add(FoodStarted());
        return foodBloc;
      },
      child: Scaffold(
        backgroundColor: Colors.cyan.withOpacity(0.01),
          ...
          child: BlocBuilder<FoodBloc, FoodState>(builder: ((context, state) {
            if (state is FoodSuccess) {
              ...
              return ResponsiveLayout(
                largeScreen: LargeFoodPage(meal_foods: state.meal_foods, user_info: state.user_info, notifications: state.notifications,),
                // smallScreen: SmallFoodPage(),
                smallScreen: SmallFoodPage(meal_foods: state.meal_foods, user_info: state.user_info,),
              );
