...
class SmallFoodPage extends StatefulWidget {
  final UserInfo user_info;
  final List<MealFoodEntity> meal_foods;
  const SmallFoodPage({Key? key, required this.user_info, required this.meal_foods}) : super(key: key);

  @override
  State<SmallFoodPage> createState() => _SmallFoodPageState();
}

class _SmallFoodPageState extends State<SmallFoodPage> {
          ...
          child: Column(
              ...
              children: [
                Padding(
                    ...
                    child: Text(
                        "غذای رزرو شده ای برای امروز ندارید"
                    )
                ),
                Padding(
                  padding: EdgeInsets.only(
            ...
            child: CarouselSlider.builder(
              // page
                ...
                itemBuilder: (
                    ...
                    int index,
                    int pageViewIndex,
                    ) =>SmallFoodCard(meal_food: meal_foods[index],)
              // Container(
              //   height:
