...
import '../../../../ui/FoodService/FoodSaleDay/screens/large.dart';
import '../../../../ui/FoodService/FoodSaleDay/screens/small.dart';
import '../../../../ui/FoodService/ReserveFood/widgets/floating_action_button.dart';
import '../../../utils/responsiveLayout.dart';

class FoodSaleDayScreen extends StatelessWidget {
  FoodSaleDayScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayout(
      largeScreen: LargeFoodSaleDayPage(),
      // smallScreen: SmallFoodPage(),
      smallScreen: SmallFoodSaleDayPage(),
    );
    // return BlocProvider(
    //   create: (context) {
