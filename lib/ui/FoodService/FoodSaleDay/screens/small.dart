...
class SmallFoodSaleDayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final FoodSaleDaySmallScreenAppBar app_bar = FoodSaleDaySmallScreenAppBar(context);
      ...
      child: BlocBuilder<FoodSaleDayBloc, FoodSaleDayState>(builder: ((context, state) {
        if (state is FoodSaleDaySuccess) {
          return Scaffold(
            ...
            //     BlocProvider.of<FoodSaleDayBloc>(context).add(ReserveFoodRefresh(picked_date: state.picked_date.addDays(1) as Jalali, SelfServiceId: state.SelfServiceId, selfservices: state.self_services));
            //   },
