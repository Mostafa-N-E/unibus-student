...
class FoodSaleDaySmallScreenAppBar {
  // final date_piker_onTap;
  // final self_service_selecter_onTap;
  // final date_lable;
  // final self_service_lable;
  final BuildContext context;
  const FoodSaleDaySmallScreenAppBar(this.context);

  AppBar build({Function()? self_service_selecter_onTap, String self_service_lable = "( انتخاب کنید )",}) {
...
class FoodSaleDayLargeScreenAppBar {
  // final date_piker_onTap;
  // final self_service_selecter_onTap;
  // final date_lable;
  // final self_service_lable;
  final BuildContext context;
  const FoodSaleDayLargeScreenAppBar(this.context);
