...
class FoodReserveCard extends StatefulWidget {
  ...
  @override
  _FoodReserveCardState createState() => _FoodReserveCardState();
}

class _FoodReserveCardState extends State<FoodReserveCard> {
                        ...
                        children: [
                          Align(
                            ...
                            child: fast_cached_image_builder(
                                main_image_url: widget.meal_food.food.image, placeholder_image_path: 'assets/images/food.png', width: image_width * 0.95, height: image_width * 0.95
                            ),
                          ),
                          Positioned(
                            // top: (width * 0.33),
                              right: (image_width * 0.65),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          widget.meal_food.enable_main_reserve ?
                          InkWell(
                              child: Card(
                                  shape: RoundedRectangleBorder(
                              ...
                              onTap: () {
                                ...
                                // );
                                if(has_reserve){
                                  MealFood_API().delete_reserve_meal_food({
                                    ...
                                    setState(() {
                                      ...
                                      if(item_data['status'] == true){
                                        widget.meal_food.reserved.remove(global_userInfo.id);
                                      }

                                      // Navigator.of(context,rootNavigator:true).pop();
                                      ShowSnackBar().showSnackBar(
                                          context,
                                          item_data!['message'],//item_data!['status']? "با موفقیت حذف شد" : "خطا در بارگیری",
                                  ...
                                  MealFood_API().reserve_meal_food({
                                    "meal_food_id": widget.meal_food.id,
                                  }).then((fetch_data) {
                                    print(fetch_data);
                                    setState(() {
...
class LargePageFoodReserveCard extends StatefulWidget {
  MealFoodEntity meal_food;
  LargePageFoodReserveCard({
    Key? key,
    required this.meal_food
  }) : super(key: key);

  @override
  _LargePageFoodReserveCardState createState() => _LargePageFoodReserveCardState();
}

class _LargePageFoodReserveCardState extends State<LargePageFoodReserveCard> {
  // Map profile_data = Hive.box('cache').get('profile_data');
  bool has_reserve = false;
  Map item_data = {};
  bool item_fetched = true;
                                ...
                                if(has_reserve){
                                  MealFood_API().delete_reserve_meal_food({
                                    ...
                                    setState(() {
                                      ...
                                      ShowSnackBar().showSnackBar(
                                        context,
                                        item_data!['status']? "با موفقیت حذف شد" : "خطا در بارگیری",
                                        duration: const Duration(seconds: 1),
                                        noAction: false,
                                        text_color: Colors.white,
                                        background_color: item_data!['status']
                                  ...
                                  MealFood_API().reserve_meal_food({
                                    ...
                                    setState(() {
                                      ...
                                      ShowSnackBar().showSnackBar(
                                        context,
                                        item_data!['status']?"با موفقیت اضافه شد":"خطا در بارگیری",
                                        duration: const Duration(seconds: 1),
                                        noAction: false,
                                        text_color: Colors.white,
                                        background_color: item_data!['status']
