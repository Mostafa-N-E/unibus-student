            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.only(
                      right: 10),
                  child: Text(
                    widget.meal_food.date.toPersianDigit(),
                    style: TextStyle(
                      // color: isDarkMode
                      //     ? Colors.white
                      //     : Colors.white,
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            title: (100*(widget.meal_food.like.length/widget.meal_food.users_ate.length)).toStringAsFixed(2).toString().toPersianDigit() + "%",
            radius: radius,
        ...
        case 1:
          return PieChartSectionData(
            ...
            title: (100*(widget.meal_food.refused.length/widget.meal_food.users_ate.length)).toStringAsFixed(2).toString().toPersianDigit() + "%",
            radius: radius,
            titleStyle: TextStyle(
              fontSize: fontSize,
              fontWeight: FontWeight.bold,
        ...
        case 2:
          return PieChartSectionData(
            ...
            title: (100*(widget.meal_food.dislike.length/widget.meal_food.users_ate.length)).toStringAsFixed(2).toString().toPersianDigit() + "%",
            radius: radius,
            titleStyle: TextStyle(
              fontSize: fontSize,
              fontWeight: FontWeight.bold,
        ...
        case 3:
          return PieChartSectionData(
            ...
            title: (100*((widget.meal_food.users_ate.length-(widget.meal_food.like.length+widget.meal_food.refused.length+widget.meal_food.dislike.length))/widget.meal_food.users_ate.length)).toStringAsFixed(2).toString().toPersianDigit() + "%",
            radius: radius,
            titleStyle: TextStyle(
              fontSize: fontSize,
              fontWeight: FontWeight.bold,
